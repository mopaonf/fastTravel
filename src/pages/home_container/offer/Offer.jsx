  ...
  return (
    <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 mb-[8ch]'>
      <div className="w-full items-center flex justify-between">
        ...
        <Link to={"/offer"} className='test-violet-600'>View All</Link>
      </div>
      <div className="grid grid-cols-2 gap-16">
        ...
        <div className="w-full h-auto rounded-xl bg-zinc-200/30 dark:bg-zinc-800/20 p-8 flex items-center gap-x-3 shadow-md">
          ...
          <div className="flex flex-1 flex-col spcae-y-5">
            <h1 className="text-xl font-semibold text-neutral-800 dark:text-neutral-500">
