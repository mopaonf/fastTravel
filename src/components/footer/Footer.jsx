      ...
      <div className="grid grid-cols-5 gap-5">
        <div className="space-y-5 col-span-2">
          ...
          <p className="text-neutral-600 dark:text-neutral-500 text-base font-normal pr-10">
            Emporing seamless travel experiences through innovative technology and exceptional services, transforming the way you travel, one journey at a time, Fast and flexible travel solutions for the modern adventures feel free to use this services to reach us.
          </p>
        </div>
